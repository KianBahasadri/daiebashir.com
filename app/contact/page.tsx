    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl w-full text-center space-y-8">
        <h1 className="text-5xl font-bold tracking-tight">
          Connect with Daie Bashir
        </h1>
        <div className="text-lg text-gray-300 leading-relaxed">
          <p>
            With a legacy of innovation and a commitment to excellence, Daie Bashir stands at the forefront of the industry. His work is not just about creating solutions; it’s about setting new standards and inspiring what’s next. He believes in the power of collaboration and is dedicated to bringing visionary ideas to life.
          </p>
        </div>
        <div className="pt-4">
